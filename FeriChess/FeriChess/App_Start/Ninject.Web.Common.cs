[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(FeriChess.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(FeriChess.App_Start.NinjectWebCommon), "Stop")]

namespace FeriChess.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IEngineCommunicator>().ToConstant(new EngineCommunicator());
